...
bool PlanningComponent::Init() {
  ...
  if (FLAGS_use_navigation_mode) {
    ...
    planning_base_ = std::make_unique<OnLanePlanning>(injector_);  //执行OnLanePlanning对象的生成
  }
  ...
  if (FLAGS_planning_offline_learning ||    //FLAGS_planning_offline_learning:默认为false
      config_.learning_mode() != PlanningConfig::NO_LEARNING) {   //learning_mode：默认NO_LEARNING

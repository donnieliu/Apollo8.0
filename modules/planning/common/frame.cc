...
FrameHistory::FrameHistory()
    : IndexedQueue<uint32_t, Frame>(FLAGS_max_frame_history_num) {}   //  1
...
const Obstacle *Frame::CreateStopObstacle(
  ...
  const double box_center_s = obstacle_s + FLAGS_virtual_stop_wall_length / 2.0;  //FLAGS_virtual_stop_wall_length：0.1
